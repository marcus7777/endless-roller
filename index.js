...
function createScene(){
	...
	window.addEventListener('resize', onWindowResize, false);//resi
...
function doTreeLogic(){
	...
	treesInPath.forEach( function ( element, index ) {
        ...
        heroSphere.scale.y = heroScale
        heroSphere.scale.z = heroScale
        if (heroScale > maxSize || heroScale < minSize) {
          location.reload()
        }
			}
		}
...
if (typeof Accelerometer != "underfine") {
  let acl = new Accelerometer({frequency: 12});
